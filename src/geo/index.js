...
class ThreeGeo {
    constructor(opts={}) { 
        const defaults = {
            ...
            isNode: false,
            isDebug: false,                  //是否调试状态
            apiVector: 'mapbox-terrain-vector',
            apiRgb: 'mapbox-terrain-rgb',    //法线贴图存放位置
            apiSatellite: 'mapbox-satellite',//卫星地图存放位置
        };
                ...
                if (onRgbDem) {
                    (new RgbModel({
                        unitsPerMeter, projectCoord,
                         isNode, isDebug, apiRgb, apiSatellite,
